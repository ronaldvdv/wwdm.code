...
namespace WWDM.GraphQL.Schema
{
    public class Query
    {
        ...
        public Task<Episode> GetEpisodeAsync(int id, EpisodeByIdDataLoader dataLoader, CancellationToken cancellationToken) => dataLoader.LoadAsync(id, cancellationToken);
    }
}